...
- `settings.cfg` documents the default ElevenLabs backend and the local Whisper fallback.
...
- ElevenLabs keyterms are used for DCS, VAICOM, callsigns, and radio vocabulary biasing.
