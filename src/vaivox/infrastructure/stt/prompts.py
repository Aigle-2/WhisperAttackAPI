"""Default textual prompts for STT backends that accept context biasing."""

from __future__ import annotations

DEFAULT_DCS_PROMPT = (
    "This is aviation-related speech for DCS Digital Combat Simulator, "
    "spoken in English and often by non-native English speakers with strong accents. "
    "Expect radio commands, military aviation phrasing, airports in Caucasus Georgia "
    "and Russia, and callsigns like Enfield, Springfield, Uzi, Colt, Dodge, "
